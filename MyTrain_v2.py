...
parser.add_argument('--dataset_root', default=My_ROOT, help='Dataset root directory path')
...
def train():
    cfg = voc
    dataset = MyDetection(root=os.path.join(HOME, "workspace/Data/"), datasetfile='8000list',
